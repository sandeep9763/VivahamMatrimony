...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Us | Vivaham Matrimony</title>
        <meta name="description" content="Get in touch with the Vivaham Matrimony team. We're here to help you with any questions or concerns." />
      </Helmet>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-600">info@vivahammatrimony.com</p>
                  </div>
                </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="flex space-x-4">
                    <a href="#" className="bg-primary bg-opacity-10 p-2 rounded-full text-primary hover:bg-primary hover:text-white transition-colors">
